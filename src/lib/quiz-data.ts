...
export const quizSteps: QuizStep[] = [
  ...
  },
  {
    ...
    image: U("1579722820308-d74e571900a9"),
    imageAlt: "Person scooping a supplement powder in a bright kitchen",
    options: [
  ...
  // ---------------------------------------------------------------------
  {
    ...
    imageAlt: "Calm, well-designed bedroom for restful sleep",
    booleans: [
