...
export const EVIDENCE_MATRIX: Record<string, EvidenceEntry> = {
  vitamin_d: {
    ...
    avoidWhen: ["Hypercalcemia", "Active sarcoidosis"],
    downgradeWhen: ["Already supplementing without labs"],
  },
  b12: {
    supplementId: "b12",
    supportedClaims: [
    ...
    notUsefulFor: ["Generic 'energy boost' in B12-replete adults"],
  },
  omega3: {
    supplementId: "omega3",
    supportedClaims: [
    ...
    clinicianOnlyWhen: ["On warfarin or other anticoagulants", "Surgery within 14 days"],
    downgradeWhen: ["Regular oily-fish eater (>=2x/week)"],
  },
  magnesium: {
    ...
    clinicianOnlyWhen: ["Chronic kidney disease"],
  },
  creatine: {
    ...
    clinicianOnlyWhen: ["Significant kidney disease"],
    avoidWhen: ["Under 18 without pediatric sports-medicine guidance"],
  },
  protein: {
  ...
  iron: {
    ...
    avoidWhen: ["Hereditary hemochromatosis", "Elevated ferritin without anemia"],
    clinicianOnlyWhen: ["All adults — confirm ferritin/CBC first"],
    notUsefulFor: ["Generic 'energy' in iron-replete adults"],
  },
  calcium: {
    ...
    downgradeWhen: ["Dietary calcium already adequate"],
  },
  prenatal: {
    ...
    lastChecked: LAST_CHECKED,
    clinicianOnlyWhen: ["All — choose specific formula with obstetric clinician"],
    avoidWhen: ["Not pregnant/breastfeeding/trying to conceive"],
  },
  electrolytes: {
  ...
  fiber: {
    ...
    avoidWhen: ["Bowel obstruction", "Swallowing difficulty"],
  },
  probiotic: {
    ...
    labRequirement: "none",
    lastChecked: LAST_CHECKED,
    clinicianOnlyWhen: ["Severely immunocompromised"],
    notUsefulFor: ["Routine 'gut health' in healthy adults without a specific indication"],
  },
  zinc: {
    supplementId: "zinc",
    supportedClaims: [
    ...
    avoidWhen: ["Intranasal zinc — anosmia risk"],
    notUsefulFor: ["Chronic daily use — risks copper deficiency"],
  },
  vitamin_c: {
    ...
    downgradeWhen: ["High fruit/vegetable intake"],
    notUsefulFor: ["Preventing colds in the general population"],
  },
  melatonin: {
    ...
    avoidWhen: ["Pregnancy", "Breastfeeding", "Under 18 without pediatric clinician"],
    clinicianOnlyWhen: ["On sedatives, blood thinners, or immunosuppressants"],
  },
};
